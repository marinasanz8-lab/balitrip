// Configuración de Firebase para que todos tus viajes (lista, checklist,
// vuelos, hoteles, itinerario, presupuesto...) se sincronicen entre todos
// los que abran esta web (familia).
//
// Sin rellenar esto, la web sigue funcionando perfectamente pero cada
// persona ve solo su propia copia guardada en su navegador. En cuanto se
// rellena con datos reales y se publica, los cambios de cualquiera se ven
// al instante en todos los dispositivos.
//
...
//      la escritura/lectura a tu espacio (todos tus viajes):
//        {
//          "rules": {
//            "workspaces": {
//              "$workspaceId": { ".read": true, ".write": true }
//            }
//          }
//        }
//   6. Cambia WORKSPACE_ID más abajo por algo único y difícil de adivinar
...
window.WORKSPACE_ID = "bali-gili-lombok-2026-mvem4";
